                    ...
                    <div class="login-form col s12 m5 offset-m7">
                        <form method="post" action="/login" name="login_form">
                            ...
                            <div class="input-field col s10 offset-s1 m5">
                                  <input id="email" type="text" class="validate col s12" placeholder="Email" required name="email">
                            </div>
                            <div class="input-field col s10 offset-s1 m5" style="border-right:1px solid lightgrey">
                                  <input name="password" id="password" type="password" class="validate col s12" placeholder="Password" required>
                            </div>
